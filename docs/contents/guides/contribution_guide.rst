...
To run the wiki locally, navigate to the ``docs/`` directory:

.. code-block:: console

   cd docs/

Set up a Python virtual environment and install the dependencies (this only needs to be done once):
...
The wiki will be available at http://localhost:8000.
